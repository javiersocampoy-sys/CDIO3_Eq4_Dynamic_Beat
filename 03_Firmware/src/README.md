...
*   **`C`**: Contiene los scripts en Python que conforman la interfaz gráfica y el sistema de procesamiento. Esta aplicación lee los datos del puerto serie, los procesa y proporciona retroalimentación visual en tiempo real. 
